...
We demonstrate the use of SpaCOAP to one mouse spleen data collected from the SPOTS platform that are [here](https://github.com/feiyoung/SpaCOAP/tree/main/vignettes_data), which can be downloaded to the current working path by the following command:
```{r eval=FALSE}
url1 <- "https://github.com/feiyoung/SpaCOAP/main/vignettes_data/"
